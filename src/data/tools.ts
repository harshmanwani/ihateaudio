...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    icon: 'wave-square',
    icon3d: true,
    keywords: ['mp3 to wav convert to wav convert audio to wav wav converter uncompressed pcm lossless'],
  ...
  },
  {
    ...
    description:
      'Compress an audio file to make it smaller by lowering the bitrate, sample rate or channel count. See the projected size before you download. No upload required.',
    ...
    icon3d: true,
    keywords: ['compress audio shrink reduce file size smaller mb email whatsapp limit kb mp3'],
  ...
  // ---------------- Speed & pitch ----------------
  {
    ...
    icon: 'fast-forward',
    icon3d: true,
    keywords: ['speed up slow down faster slower playback rate 2x 0.5x sped up audio speed changer speed changer'],
  ...
  },
  {
    slug: 'pitch-shifter',
    name: 'Pitch Changer',
    title: 'Pitch Changer Online Free: Shift Audio Pitch by Semitones',
    description:
      'Change the pitch of any audio file up or down by semitones without changing the length. Real time-stretching, so voices stay natural instead of turning into chipmunks.',
    tagline: "Move the pitch, leave the length exactly where it was.",
    short: "Shift a track up or down by semitones.",
    category: 'speed',
    icon: 'arrows-vertical',
    icon3d: true,
    keywords: ['pitch changer shifter up down higher lower deeper semitone transpose key change audio pitch'],
  ...
  // ---------------- Effects ----------------
  {
    slug: 'reverb-adder',
    name: 'Reverb Adder',
    title: 'Reverb Adder Online Free: Add Reverb to Audio Files',
    description:
    ...
    icon: 'waves',
    icon3d: true,
    keywords: ['reverb adder echo room hall cathedral space wet ambience add reverb effect'],
  ...
  },
  {
    ...
    icon: 'heartbeat',
    icon3d: true,
    keywords: ['bpm detector tempo finder beats per minute what bpm song speed detect change bpm test'],
  ...
  },
  {
    ...
    icon: 'gauge',
    icon3d: true,
    keywords: ['lufs meter loudness measuring check measure true peak dbfs how loud'],
